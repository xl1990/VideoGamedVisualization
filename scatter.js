...
function create_scatter(data,groupKey) {
	...
	const data_columns = ["Name", "Global_Sales", "Critic_Score", "User_Score", "NA_Sales",	"EU_Sales",	"JP_Sales",	"Other_Sales", groupKey],
				scatter_columns = ["Global_Sales", "Critic_Score", "User_Score", "NA_Sales",	"EU_Sales",	"JP_Sales",	"Other_Sales"],
	...
	scatter_svg.selectAll("circle")
		 ...
		 .on("mouseover", function(d,i) {
				...
				div.html("<div> Name: "+ d.Name + "<br/>" + 
						"Global Sales: $" + d.Global_Sales + " million<br/>" +
						"NA Sales: $" + d.NA_Sales + " million<br/>" +
						"EU Sales: $" + d.EU_Sales + " million<br/>" +
						"JP Sales: $" + d.JP_Sales + " million<br/>" +
						"Other Sales: $" + d.Other_Sales + " million<br/>" +
